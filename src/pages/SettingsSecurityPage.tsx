    ...
    <PageShell title="Setting">
      <Card className="p-0 shadow-none">
        ...
        <div className="px-8 pb-8 pt-10">
          <div className="text-[15px] font-semibold text-[var(--color-heading)]">Security</div>
          <p className="mt-2 text-[13px] leading-6 text-[var(--color-muted)]">
            This screen is included to match the Figma routes. Add password/2FA controls here.
          </p>
        </div>
      </Card>
    </PageShell>
